...
.method private crypt_raw([B[BI)[B
    .locals 9
    .param p1, "password"    # [B
    .param p2, "salt"    # [B
    ...
    .prologue
    .line 613
    sget-object v7, Lorg/mindrot/jbcrypt/BCrypt;->bf_crypt_ciphertext:[I
    ...
    const-string v8, "Bad number of rounds"
    ...
    const-string v8, "Bad salt length"
    ...
    invoke-direct {p0, v0, v7}, Lorg/mindrot/jbcrypt/BCrypt;->encipher([II)V
...
.method private static decode_base64(Ljava/lang/String;I)[B
    ...
    .line 439
    .local v9, "rs":Ljava/lang/StringBuffer;
    const/4 v5, 0x0
    ...
    const-string v12, "Invalid maxolen"
    ...
    invoke-static {v11}, Lorg/mindrot/jbcrypt/BCrypt;->char64(C)B
...
.method private ekskey([B[B)V
    ...
    invoke-static {p2, v2}, Lorg/mindrot/jbcrypt/BCrypt;->streamtoword([B[I)I
    ...
    invoke-static {p1, v0}, Lorg/mindrot/jbcrypt/BCrypt;->streamtoword([B[I)I
    ...
    .line 588
    invoke-direct {p0, v3, v9}, Lorg/mindrot/jbcrypt/BCrypt;->encipher([II)V
...
.method private static encode_base64([BI)Ljava/lang/String;
    ...
    .line 386
    .local v4, "rs":Ljava/lang/StringBuffer;
    if-lez p1, :cond_0
...
.method public static gensalt(ILjava/security/SecureRandom;)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, Lorg/mindrot/jbcrypt/BCrypt;->encode_base64([BI)Ljava/lang/String;
...
.method public static hashpw(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 663
    .local v7, "rs":Ljava/lang/StringBuffer;
    const/4 v10, 0x0
    ...
    const-string v11, "Invalid salt version"
    ...
    const-string v11, "Missing salt rounds"
    ...
    const-string v11, "Invalid salt revision"
    ...
    .line 689
    .local v4, "passwordb":[B
    const/16 v10, 0x10

    invoke-static {v5, v10}, Lorg/mindrot/jbcrypt/BCrypt;->decode_base64(Ljava/lang/String;I)[B

    move-result-object v8

    .line 691
    .local v8, "saltb":[B
    new-instance v0, Lorg/mindrot/jbcrypt/BCrypt;

    invoke-direct {v0}, Lorg/mindrot/jbcrypt/BCrypt;-><init>()V

    .line 692
    .local v0, "B":Lorg/mindrot/jbcrypt/BCrypt;
    invoke-direct {v0, v4, v8, v6}, Lorg/mindrot/jbcrypt/BCrypt;->crypt_raw([B[BI)[B
    ...
    invoke-static {v8, v10}, Lorg/mindrot/jbcrypt/BCrypt;->encode_base64([BI)Ljava/lang/String;
    ...
    .line 705
    sget-object v10, Lorg/mindrot/jbcrypt/BCrypt;->bf_crypt_ciphertext:[I
    ...
    invoke-static {v1, v10}, Lorg/mindrot/jbcrypt/BCrypt;->encode_base64([BI)Ljava/lang/String;
    ...
    .line 684
    .end local v0    # "B":Lorg/mindrot/jbcrypt/BCrypt;
    .end local v1    # "hashed":[B
    .end local v4    # "passwordb":[B
    ...
    const-string v11, "UTF-8 is not supported"
...
.method private key([B)V
    ...
    .line 556
    invoke-direct {p0, v2, v8}, Lorg/mindrot/jbcrypt/BCrypt;->encipher([II)V
